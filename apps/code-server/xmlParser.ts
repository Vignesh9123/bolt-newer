...
export class XMLParser {
  ...
  private chatBlockId: string;
  constructor(data:{currentString?: string, onFileCommand?: (filePath: string, content: string) => void, onShellCommand?: (content: string) => void, currentProjectId: string, chatBlockId: string}) {
    ...
    this.chatBlockId = data.chatBlockId;
  }
